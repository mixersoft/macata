...
EventsResource = (Resty, amMoment) ->
  ...
  service.XXXget = (id)->
    return Resty.prototype.get.apply(this, arguments)
    .then (result)->
      console.info "TODO: setVisibleLocation()"  # need to verify participation
      return result

  service.XXXquery = (filter)->
    return Resty.prototype.get.call(this, 'all')
    .then (rows)->
