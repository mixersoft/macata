...
demoData = {
  ...
  'mcEvents': {
    0:
      ...
      # host:
      ownerId: "CDF8Y54kkRfPQnsmR" # markymark belongsTo Users
    ...
    1:
      ...
      participantIds: ["CDF8Y54kkRfPQnsmR"]
